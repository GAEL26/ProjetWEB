...
function Reg_img1() {
  document.getElementById("image").src="imageregle1.gif";  //ECRIRE ENTRE LES GUILLEMETS LE NOM DU FICHIER image
...
function Reg_img2() {
  document.getElementById("image").src="imageregle2.gif";  //ECRIRE ENTRE LES GUILLEMETS LE NOM DU FICHIER image
...
function Reg_img3() {
  document.getElementById("image").src="imageregle3.gif";  //ECRIRE ENTRE LES GUILLEMETS LE NOM DU FICHIER image
...
function Reg_img4() {
  document.getElementById("image").src="imageregle4.gif";  //ECRIRE ENTRE LES GUILLEMETS LE NOM DU FICHIER image
...
function Reg_img5() {
  document.getElementById("image").src="imageregle5.gif";  //ECRIRE ENTRE LES GUILLEMETS LE NOM DU FICHIER image
